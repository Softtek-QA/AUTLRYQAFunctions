...
public abstract class AUTVAProjectFunctions{
	 ...
	 * 
	 * @return boolean - True caso o procedimento seja realizado com sucesso false caso contrário
	 * 
	 */
	public static boolean autLogin(Desktop agent,String user,String password) {
		try {			
			...
			AUT_CURRENT_LOG_OBJECT.logMensagem(AUT_TIPO_MSG_LOG.MENSAGEM_INFORMATIVA, "AUT ERROR: LOGIN : APLICACAO VA");
