...
public class AUTProjectsFunctions {	
	...
	public static enum AUT_OPTION_CALC_MODULOS{
		/**
		 * 
		 * REPRESENTA VALORES EM QUE O RESTO GERADO PELO CALCULO DO M�DULO � MAIOR QUE ZERO
		 * 
		 */
		...
		/**
		 * 
		 * REPRESENTA VALORES EM QUE O RESTO GERADO PELO CALCULO DO M�DULO EST� ENTRE LIMITES DEFINIDOS (MINIMO E MAXIMO DO RESTO)
		 * 
		 */
	...
	/**
	 * Classe respons�vel pelo desenvolvimento de express�es regulares para teste e formata��o de dados
	 * 
	 * @author Softtek - QA
	 *
	 */
